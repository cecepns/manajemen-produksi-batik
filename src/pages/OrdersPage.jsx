...
const emptyStep = () => ({ nama_step: '', assigned_worker_id: '' });
...
const defaultSteps = () => [
  { ...emptyStep(), nama_step: 'Pewarnaan awal' },
  { ...emptyStep(), nama_step: 'Detail motif' },
  { ...emptyStep(), nama_step: 'Finishing' },
];
              ...
              <tbody className="divide-y divide-slate-100">
                {orders.map((o) => (
                  <tr key={o.id} className="transition hover:bg-slate-50/80">
                    <td className="px-4 py-3 font-medium text-batik-ink">{o.nama_pemesan}</td>
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-6 py-4">
              ...
              {orderModal.mode === 'create' ? (
                <div className="mt-4">
                  <p className="text-sm font-medium text-batik-ink">Tahapan workflow (sesuaikan nama)</p>
                  <div className="mt-2 space-y-3">
                    {steps.map((s, i) => (
                      <div
                        key={i}
                        className="flex flex-col gap-2 rounded-lg border border-slate-200 bg-slate-50/50 p-3 sm:flex-row sm:items-end"
                      >
